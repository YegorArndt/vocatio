...
export const Timeline = (props: TimelineProps) => {
  ...
  useEffect(() => {
     ...
     */
    const canFetchAndSet = !isLoading && !isError && jobDescription;
  ...
  useEffect(() => {
    if (stories.length && data?.content) {
      const newStories = [...stories, data.content];
      setStoriesToLocalStorage(newStories, vacancyId);
  ...
  return (
    <>
      ...
      {!DOWNLOAD_FIRED && (
        <Button
          className="sm common ml-auto border"
          onClick={onClick}
