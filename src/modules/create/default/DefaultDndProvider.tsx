...
import { Contact } from "../design/base-components/Contact";
import {
  CrudContext,
  addComponent,
  removeComponent,
} from "../design/base-components/dnd/crud";
import { Toolbar } from "../design/base-components/toolbars";
import { ContactToolbar } from "../design/base-components/toolbars/ContactToolbar";
import { ExperienceEntryToolbar } from "../design/base-components/toolbars/experience/ExperienceEntryToolbar";
import { ExperienceToolbar } from "../design/base-components/toolbars/experience/ExperienceToolbar";
import { SkillsToolbar } from "../design/base-components/toolbars/skills/SkillsToolbar";
import {
  useComponentContext,
  ComponentContext,
} from "../design/contexts/ComponentContext";
import { DefaultProfessionalSummary } from "./DefaultProfessionalSummary";
import { DefaultJobTitle } from "./DefaultJobTitle";
import { ExperienceEntry } from "../design/base-components/ExperienceEntry";
import { Entry } from "../design/base-components/Entry";
...
const mapping: Mapping = [
  ...
  { keys: ["jobTitle"], Component: DefaultJobTitle, Toolbar },
  {
    keys: ["professionalSummary"],
    Component: DefaultProfessionalSummary,
    Toolbar,
  },
  {
  ...
  { keys: ["entry"], Component: Entry, Toolbar },
...
export const DefaultDndProvider = forwardRef((props: DndProviderProps, ref) => {
...
DefaultDndProvider.displayName = "DndProvider";
