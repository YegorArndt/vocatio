...
const right: RawComponent[] = [
  {
    ...
    props: (data) => ({
      ...
      value: data.name,
      className:
        "flex flex-col !text-[50px] !gap-0 leading-[1] first:font-bold mb-2",
      tooltip: "name",
    }),
  },
...
export const Pickachu: RawDesign = {
  id: PickachuId,
  name: "Pickachu",
  ...
  sections: {
    left: {
      ...
      components: left,
      className:
        "left flex flex-col items-center bg-[#f5f5f5] !pt-[42px] [&_.icon-group]:mt-[8px] [&_.group]:mt-[8px] [&_.group]:grid-cols-[80px,1fr]",
    },
    right: {
      id: "right",
      components: right,
      className:
        "right bg-[#fff] text-[#000] !pt-[42px] [&_.group]:grid-cols-2",
    },
  },
  intrinsic: {
    "heading-1": {
